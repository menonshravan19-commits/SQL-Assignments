...
Select * from Employees where Salary>50000 and Hire_date < '2016-1-1';

Select * from employees where Designation is null;

Update Employees set Designation = 'Data_Scientist' where Designation is null;

select * from employees 
Order by Department_ID ASC , Salary desc;

select * from employees
where year(Hire_date) = 2018 order 
by Hire_date 
limit 5;
...
update location set location_ID = 4 where location_ID =8;
...
from Employees e
Join location l on e.location_ID = l.Location_ID
where e.Gender = 'F' group by l.location having Avg(e.age) < 30;
